...
describe('AppointmentForm', () => {
  ...
  const labelFor = formElement =>
    document.querySelector(`label[for="${formElement}"]`);
  const startsAtField = index =>
    document.querySelectorAll(`input[name="startsAt"]`)[index];
  ...
  describe('stylist field', () => {
    ...
    it('lists only stylists that can perform the selected service', () => {
      ...
      act(() => ReactTestUtils.Simulate.change(field('service'), {
  ...
  const timeSlotTable = () =>
    document.querySelector('table#time-slots');
  ...
  describe('time slot table', () => {
    ...
    it('saves existing value when submitted', async () => {
      ...
      act(() => ReactTestUtils.Simulate.submit(form('appointment')));
    });
    ...
    it('saves new value when submitted', () => {
      ...
      act(() => ReactTestUtils.Simulate.change(startsAtField(1), {
        target: {
    ...
    it('filters appointments by selected stylist', () => {
      ...
      act(() => ReactTestUtils.Simulate.change(field('stylist'), {
